...
Player submits AI code, chooses opponent and then just sits and watching his robot fighting.

<h3>How it works</h3>
Player was able to write code in Php, Js or Java! When fight starts Php gameCore start fight generating. It sends requests to code servers (php,js or java)
and receive robot actions. When fight is over gameCore creates game log in json format and send it to player browser. 
