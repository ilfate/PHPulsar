...
use \Core\Interfaces\Request as RequestInterface;
...
class Request implements RequestInterface
{
    ...
    {
        $escapeFunction = function (&$item, $key) {
        ...
        if ($this->post) {
            array_walk_recursive($this->post, $escapeFunction);
        }
        if ($this->get) {
            array_walk_recursive($this->get, $escapeFunction);
        }
    }
